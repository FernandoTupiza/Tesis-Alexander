...
class MateriasEstudianteController extends Controller
{
    //FUNCION PARA CREAR MATERIAS
    public function store_estudiante (Request $request, Semestres $semestres)
    {
        ...
        public function index__estudianteE  (Request $request){
        ...
        public function destroy_estudiante (Materias $materias){
